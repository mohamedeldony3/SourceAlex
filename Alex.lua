...
- Hi Bro in Ramo Source .
- Source Channels => @T_O_Y_S & @T_O_Y_S & @T_O_Y_S & @T_O_Y_S .
- Written BY => @Ramo41 & @Moghoury_bot .
]].."\27[m")

io.popen("mkdir Ramo_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls Ramo_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."Ramo:Sudo:User", msg.sender_user_id_) 
if hash or DevRamo(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."Ramo:Basic:Constructor23"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevRamo(msg) or DevBot(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevRamo(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."Ramo:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevRamo(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."Ramo:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevRamo(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."Ramo:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevRamo(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."Ramo:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevRamo(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Ramo:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."Ramo:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."Ramo:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Ramo:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Ramo:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."Ramo:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
var = "مطور السورس"
elseif DevRamoe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."Ramo:Sudo:User", user_id) then
var = database:get(bot_id.."Ramo:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."Ramo:Basic:Constructor23"..chat_id, user_id) then
var = "المالك"
elseif database:sismember(bot_id.."Ramo:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Ramo:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."Ramo:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Ramo:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."Ramo:Manager"..chat_id, user_id) then
var = database:get(bot_id.."Ramo:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."Ramo:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."Ramo:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."Ramo:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."Ramo:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."Ramo:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."Ramo:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."Ramo:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Ramo:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Ramo:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local UserName = (data.username_ or "T_O_Y_S")
for Ramo in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = Ramo
end
...
database:sadd(bot_id..'Ramo:Chek:Groups',idg) 
database:set(bot_id.."Ramo:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Ramo:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."Ramo:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."Ramo:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."Ramo:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."Ramo:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."Ramo:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function Ramo_Files(msg)
for v in io.popen('ls Ramo_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Ramo_Files/"..v)
if plugin.Ramo and msg then
pre_msg = plugin.Ramo(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function Ramo_Started_Bot(msg,data) 
if msg then
...
database:incr(bot_id..'Ramo:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'Ramo:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."Ramo:Ramo:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."Ramo:Ramo:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Ramo:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'Ramo:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'Ramo:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'Ramo:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'Ramo:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."Ramo:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."Ramo:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Ramo:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."Ramo:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."Ramo:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."Ramo:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Ramo:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Ramo:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Ramo:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."Ramo:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Ramo:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."Ramo:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."Ramo:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."Ramo:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."Ramo:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Ramo:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."Ramo:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."Ramo:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."Ramo:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."Ramo:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."Ramo:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."Ramo:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."Ramo:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."Ramo:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Ramo:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء وضع البايو .") 
database:del(bot_id.."Ramo:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Ramo:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Ramo:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء حفظ الترحيب .") 
database:del(bot_id.."Ramo:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Ramo:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."Ramo:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"◈︙ تم حفظ الترحيب عمري .")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Ramo:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"◈︙ تم الغاء حفظ الرابط .")       
database:del(bot_id.."Ramo:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."Ramo:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."Ramo:Ramo:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."Ramo:Ramo:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'Ramo:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."Ramo:Ramo:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."Ramo:Ramo:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Ramo:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."Ramo:Ramo:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."Ramo:Ramo:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."Ramo:Ramo:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."Ramo:Ramo:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."Ramo:UsersBot")   
...
local Ramo_Msg = database:get(bot_id.."Ramo:Add:Filter:Rp2"..text..msg.chat_id_)   
if Ramo_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","◈︙"..Ramo_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."Ramo:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء حفظ اسم البوت .") 
database:del(bot_id.."Ramo:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."Ramo:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."Ramo:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "◈︙ تم حفظ اسم البوت .")  
return false
end 
if text and database:get(bot_id.."Ramo:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."Ramo:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◈︙ ارسل الامر الجديد عمري .")  
database:del(bot_id.."Ramo:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."Ramo:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."Ramo:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."Ramo:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."Ramo:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."Ramo:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◈︙ تم حفظ الامر .")  
database:del(bot_id.."Ramo:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."Ramo:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."Ramo:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Ramo:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Ramo:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."Ramo:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Ramo:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."Ramo:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."Ramo:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."Ramo:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."Ramo:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."Ramo:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Ramo:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."Ramo:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."Ramo:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."Ramo:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."Ramo:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."Ramo:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."Ramo:lockpin"..msg.chat_id_)  
database:srem(bot_id.."Ramo:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."Ramo:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."Ramo:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'Ramo:'..lock..msg.chat_id_)    
end
...
database:set(bot_id.."Ramo:Lock:Markdaun"..msg.chat_id_,"ktm")  
...
if text == ("المطورين") and DevRamo(msg) then
local list = database:smembers(bot_id.."Ramo:Sudo:User")
t = "\n◈︙ قائمة مطورين البوت .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Ramo:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Ramo:Constructor"..msg.chat_id_)
t = "\n◈︙ قائمة المنشئين .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Ramo:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Ramo:Manager"..msg.chat_id_)
t = "\n◈︙ قائمة المدراء .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Ramo:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Ramo:Mod:User"..msg.chat_id_)
t = "\n◈︙ قائمة الادمنية .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Ramo:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Ramo:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Ramo:Muted:User"..msg.chat_id_)
t = "\n◈︙ قائمة المكتومين .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Ramo:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Ramo:Ban:User"..msg.chat_id_)
t = "\n◈︙ قائمة المحظورين .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Ramo:User:Name" .. v)
if username then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevRamo(msg) then
function Function_Ramo(extra, result, success)
...
database:sadd(bot_id.."Ramo:GBan:User", result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم حظره عام .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Ramo, nil)
return false
end
if text and text:match("^حظر عام @(.*)$")  and DevRamo(msg) then
...
database:sadd(bot_id.."Ramo:GBan:User", result.id_)
Reply_Status(msg,result.id_,"reply","◈︙ تم حظره عام .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Ramo, nil)
return false
end
if text and text:match("^حظر عام (%d+)$") and DevRamo(msg) then
...
database:sadd(bot_id.."Ramo:GBan:User", userid)
Reply_Status(msg,userid,"reply","◈︙ تم حظره عام .")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevRamo(msg) then
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم الغاء الحظر العام عنه .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Ramo, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevRamo(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_Ramo(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","◈︙ تم الغاء الحظر العام عنه .")  
database:srem(bot_id.."Ramo:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevRamo(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."Ramo:GBan:User", userid)
Reply_Status(msg,userid,"reply","◈︙ تم الغاء الحظر العام عنه .")  
return false
end

if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevRamo(msg) then
function Function_Ramo(extra, result, success)
database:sadd(bot_id.."Ramo:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم رفعه مطور .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Ramo, nil)
return false 
end
if text and text:match("^رفع مطور @(.*)$") and DevRamo(msg) then
...
database:sadd(bot_id.."Ramo:Sudo:User", result.id_)
...
if text and text:match("^رفع مطور (%d+)$") and DevRamo(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."Ramo:Sudo:User", userid)
Reply_Status(msg,userid,"reply","◈︙ تم رفعه مطور .")  
return false 
end
if text == ("تنزيل مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevRamo(msg) then
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم حذفه من المطورين .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Ramo, nil)
return false 
end
if text and text:match("^تنزيل مطور @(.*)$") and DevRamo(msg) then
local username = text:match("^تنزيل مطور @(.*)$")
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ramo:Sudo:User", result.id_)
...
if text and text:match("^تنزيل مطور (%d+)$") and DevRamo(msg) then
local userid = text:match("^تنزيل مطور (%d+)$")
database:srem(bot_id.."Ramo:Sudo:User", userid)
...
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ramo:Basic:Constructor23"..msg.chat_id_, result.id_)
...
if database:get(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n◈︙ ارسل الكلمة الان .')
database:set(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Ramo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Ramo:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Ramo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الرد .")
database:del(bot_id..'botss:Ramo:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Ramo:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Ramo:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Ramo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Ramo:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعددة") and DevRamo(msg) then
 
local list = database:smembers(bot_id.."botss:Ramo:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Ramo:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Ramo:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Ramo:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Ramo:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الردود المتعددة .")
end
if text == ("الردود المتعددة") and DevRamo(msg) then
...
if text == "اضف رد متعدد" and DevRamo(msg) then
 
database:set(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◈︙ ارسل الرد الان .")
end
if text == "حذف رد متعدد" and DevRamo(msg) then
 
database:set(bot_id.."botss:Ramo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◈︙ ارسل الرد المراد حذفه . ")
end
if text then  
local test = database:get(bot_id.."botss:Ramo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Ramo:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Ramo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Ramo:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Ramo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Ramo:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:Ramo:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Ramo:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Ramo:Add:Rd:Sudo:Text2"..text)   
...
function Function_Ramo(extra, result, success)
database:sadd(bot_id.."Ramo:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Ramo:Basic:Constructor23"..msg.chat_id_, result.id_)
...
function Function_Ramo(extra, result, success)
database:sadd(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:sadd(bot_id.."Ramo:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Ramo:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Ramo:Constructor"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ramo:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Ramo:Constructor"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:sadd(bot_id.."Ramo:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Ramo:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Ramo:Manager"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ramo:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Ramo:Manager"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:sadd(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Ramo:Mod:User"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:sadd(bot_id.."Ramo:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Ramo:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Ramo:Special:User"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."Ramo:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local Ramort = database:get(bot_id.."Ramo:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if Ramort == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "T_O_Y_S")..")".."\n◈︙ تم رفعه : "..RTPA.." هنا .\n")   
database:set(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Ramo:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif Ramort == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "T_O_Y_S")..")".."\n◈︙ تم رفعه : "..RTPA.." هنا .\n")   
database:set(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Ramo:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif Ramort == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "T_O_Y_S")..")".."\n◈︙ تم رفعه : "..RTPA.." هنا .\n")   
database:set(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Ramo:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif Ramort == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "T_O_Y_S")..")".."\n◈︙ تم رفعه : "..RTPA.." هنا .\n")   
end
end,nil)   
end   
...
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif Ramort == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "T_O_Y_S")..")".."\n◈︙ تم تنزيله من : "..RTPA.." هنا .\n")   
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."Ramo:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local Ramort = database:get(bot_id.."Ramo:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if Ramort == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..result.title_.."](t.me/"..(text1[3] or "T_O_Y_S")..")".."\n◈︙ تم رفعه : "..text1[2].." هنا .")   
database:sadd(bot_id.."Ramo:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif Ramort == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..result.title_.."](t.me/"..(text1[3] or "T_O_Y_S")..")".."\n◈︙ تم رفعه : "..text1[2].." هنا .")   
database:sadd(bot_id.."Ramo:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif Ramort == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..result.title_.."](t.me/"..(text1[3] or "T_O_Y_S")..")".."\n◈︙ تم تنزيله من :"..text1[2].." هنا .")   
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."Ramo:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Ramo:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Ramo:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."Ramo:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."Ramo:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Ramo:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Ramo:Muted:User"..msg.chat_id_, userid)
...
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Ramo:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Ramo:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Ramo:Muted:User"..msg.chat_id_, userid)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_Ramo, nil)
return false
end
------------------------------------------------------------------------
...
if database:sismember(bot_id.."Ramo:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."Ramo:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."Ramo:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"◈︙ اني مو ادمن يحلو .")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"◈︙ معندي صلاحية التثبيت .")  
...
database:hset(bot_id.."Ramo:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."Ramo:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,"◈︙ تم تعيين وقت التكرار : ("..Num..") .") 
end
if text == "ضع رابط" or text == "وضع رابط" then
if msg.reply_to_message_id_ == 0  and Addictive(msg) then  
send(msg.chat_id_,msg.id_,"◈︙ ارسل الرابط الان .")
database:setex(bot_id.."Ramo:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "تفعيل جلب الرابط" or text == 'تفعيل الرابط' then
if Addictive(msg) then  
database:set(bot_id.."Ramo:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."Ramo:Link_Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"◈︙ تم تعطيل جلب الرابط .") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."Ramo:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"◈︙ جلب الرابط معطل .") 
return false  
end
local link = database:get(bot_id.."Ramo:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."Ramo:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:set(bot_id.."Ramo:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."Ramo:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."Ramo:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
t  = "◈︙ ارسل الترحيب الان ."
...
if database:get(bot_id.."Ramo:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."Ramo:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."Ramo:Chek:Welcome"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"◈︙ تم تفعيل الترحيب .") 
return false  
end
if text == "تعطيل الترحيب" and Addictive(msg) then  
database:del(bot_id.."Ramo:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"◈︙ تم تعطيل الترحيب .") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."Ramo:Get:Welcome:Group"..msg.chat_id_) 
...
local list = database:smembers(bot_id.."Ramo:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Ramo:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Ramo:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n◈︙ قائمة المنع .\n- - - - -\n"
for k,v in pairs(list) do  
local Ramo_Msg = database:get(bot_id.."Ramo:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Ramo_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"◈︙ ارسل التحذير الان .")  
database:set(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Ramo:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Ramo:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"◈︙ تم منع الكلمة وحفظ التحذير .")  
database:del(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Ramo:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Ramo:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Ramo:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:set(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Ramo:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Ramo:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Ramo:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:get(bot_id.."Ramo:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "◈︙ تم الغاء حفظ القوانين .") 
database:del(bot_id.."Ramo:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Ramo:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."Ramo:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."Ramo:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."Ramo:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."Ramo:List:Cmd:Group:New"..msg.chat_id_.."")
t = "◈︙ قائمة الاوامر المضافة .\n- - - - -\n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."Ramo:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."Ramo:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Ramo:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."Ramo:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"◈︙ تم حذف قائمة الاوامر المضافة .")  
end
end
if text == "اضف امر" and Constructor(msg) then
database:set(bot_id.."Ramo:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الامر القديم .")  
return false
end
if text == "حذف امر" or text == "مسح امر" then 
if Constructor(msg) then
database:set(bot_id.."Ramo:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local list = database:smembers(bot_id.."Ramo:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."Ramo:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."Ramo:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Ramo:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."Ramo:Coomds"..msg.chat_id_)
end
...
database:set(bot_id.."Ramo:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."Ramo:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."Ramo:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."Ramo:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "◈︙ تم حذف الصلاحية .") 
end
if database:get(bot_id.."Ramo:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الامر .") 
database:del(bot_id.."Ramo:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."Ramo:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."Ramo:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."Ramo:Sudo:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."Ramo:BasicConstructor:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."Ramo:Constructor:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."Ramo:Manager:Rd"..msg.chat_id_,Teext) 
...
database:set(bot_id.."Ramo:Mod:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."Ramo:Special:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."Ramo:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◈︙ تم تغيير رد العضو الى : "..Teext)
end


if text == ("مسح ردود المدير") and Owner(msg) then
local list = database:smembers(bot_id.."Ramo:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."Ramo:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."Ramo:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."Ramo:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."Ramo:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."Ramo:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."Ramo:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."Ramo:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."Ramo:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."Ramo:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."Ramo:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركة ."
elseif database:get(bot_id.."Ramo:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمة ."
elseif database:get(bot_id.."Ramo:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ستكر ."
elseif database:get(bot_id.."Ramo:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رسالة ."
elseif database:get(bot_id.."Ramo:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صورة ."
elseif database:get(bot_id.."Ramo:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيد ."
elseif database:get(bot_id.."Ramo:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف ."
elseif database:get(bot_id.."Ramo:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنية ."
end
text = text..""..k.." : ("..v..") : {"..db.."}\n"
end
...
local test = database:get(bot_id.."Ramo:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."Ramo:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Ramo:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Ramo:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Ramo:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Ramo:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Ramo:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Ramo:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Ramo:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Ramo:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."Ramo:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."Ramo:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"◈︙ ارسل الكلمة الان .")
database:set(bot_id.."Ramo:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Ramo:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
...
database:set(bot_id.."Ramo:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."Ramo:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."Ramo:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Ramo:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Ramo:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Ramo:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."Ramo:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."Ramo:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."Ramo:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."Ramo:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."Ramo:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Ramo:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الرد .")
database:del(bot_id.."Ramo:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Ramo:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Ramo:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
...
database:del(bot_id.."Ramo:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."Ramo:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."Ramo:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."Ramo:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'Ramo:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Ramo:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."Ramo:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."Ramo:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."Ramo:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."Ramo:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."Ramo:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."Ramo:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."Ramo:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'Ramo:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Ramo:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, Text)
database:sadd(bot_id.."Ramo:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevRamo(msg) then 
local list = database:smembers(bot_id.."Ramo:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."Ramo:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."Ramo:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."Ramo:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."Ramo:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."Ramo:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."Ramo:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."Ramo:Add:Rd:Sudo:File"..v)
database:del(bot_id.."Ramo:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."Ramo:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"◈︙ تم مسح ردود المطور .")
end
if text == ("ردود المطور") and DevRamo(msg) then 
local list = database:smembers(bot_id.."Ramo:List:Rd:Sudo")
text = "\n◈︙ قائمة ردود المطور .\n- - - - -\n"
for k,v in pairs(list) do
if database:get(bot_id.."Ramo:Add:Rd:Sudo:Gif"..v) then
db = " : متحركة ."
elseif database:get(bot_id.."Ramo:Add:Rd:Sudo:vico"..v) then
db = " : بصمة ."
elseif database:get(bot_id.."Ramo:Add:Rd:Sudo:stekr"..v) then
db = " : ستكر ."
elseif database:get(bot_id.."Ramo:Add:Rd:Sudo:Text"..v) then
db = " : رسالة ."
elseif database:get(bot_id.."Ramo:Add:Rd:Sudo:Photo"..v) then
db = " : صورة ."
elseif database:get(bot_id.."Ramo:Add:Rd:Sudo:Video"..v) then
db = " : فيد ."
elseif database:get(bot_id.."Ramo:Add:Rd:Sudo:File"..v) then
db = " : ملف ."
elseif database:get(bot_id.."Ramo:Add:Rd:Sudo:Audio"..v) then
db = " : اغنية ."
end
text = text..""..k.." : "..v.." "..db.."\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."Ramo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Ramo:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Ramo:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Ramo:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Ramo:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Ramo:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Ramo:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Ramo:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."Ramo:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"◈︙ تم حفظ الرد بنجاح .")
return false  
end  
...
if text == "اضف رد للكل" and DevRamo(msg) then 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الكلمة الان .")
database:set(bot_id.."Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevRamo(msg) then 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الكلمة المراد حذفها .")
database:set(bot_id.."Ramo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '◈︙ ارسل الرد الان . \n◈︙ يمكنك اضافة ( رسالة - ستكر - متحركة - فيديو - صورة - ملف ) .\n◈︙ يمكنك اضافة ما يلي .\n- `#username` : معرف المستخدم .\n- `#msgs` : عدد رسائل المستخدم .\n- `#name` : اسم المستخدم .\n- `#id` : ايدي المستخدم .\n- `#stast` : موقع المستخدم .\n- `#edit` : عدد السحكات .')
database:set(bot_id.."Ramo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."Ramo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."Ramo:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Ramo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الرد من قائمة ردود المطور .")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'Ramo:'..v..text)
end
database:del(bot_id.."Ramo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."Ramo:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."Ramo:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'Ramo:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Ramo:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."Ramo:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."Ramo:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."Ramo:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."Ramo:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."Ramo:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."Ramo:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."Ramo:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."Ramo:Sudo:User",result.id_) then
dev = "مطور " else dev = "" end
if database:sismember(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي " else crr = "" end
if database:sismember(bot_id.."Ramo:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ " else cr = "" end
if database:sismember(bot_id.."Ramo:Manager"..msg.chat_id_, result.id_) then
own = "مدير " else own = "" end
if database:sismember(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.id_) then
mod = "مدير " else mod = "" end
if database:sismember(bot_id.."Ramo:Special:User"..msg.chat_id_, result.id_) then
...
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Ramo:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Constructor"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Ramo:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Manager"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Ramo:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Ramo:Special:User"..msg.chat_id_, result.id_)
end
else
...
if database:sismember(bot_id.."Ramo:Sudo:User",result.sender_user_id_) then
dev = "مطور " else dev = "" end
if database:sismember(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي " else crr = "" end
if database:sismember(bot_id.."Ramo:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ " else cr = "" end
if database:sismember(bot_id.."Ramo:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير " else own = "" end
if database:sismember(bot_id.."Ramo:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن " else mod = "" end
if database:sismember(bot_id.."Ramo:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز " else vip = ""
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."Ramo:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."Ramo:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
if text == "رتبتي" then
local rtp = database:get(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..msg.sender_user_id_) or Get_Rank(msg.sender_user_id_,msg.chat_id_)
...
if not database:get(bot_id.."Ramo:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."Ramo:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."Ramo:Kick:Me"..msg.chat_id_,true)  
Text = "\n◈︙ تم تعطيل امر اطردني ."
send(msg.chat_id_, msg.id_,Text) 
end
...
database:srem(bot_id.."Ramo:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."Ramo:Muted:User"..msg.chat_id_,result.id_)
usertext = "\n◈︙ العضو : ["..result.title_.."](t.me/"..(username or "T_O_Y_S")..")"
status  = "\n◈︙ تم رفع القيود عنه ."
...
function Function_Ramo(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."Ramo:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Ramo:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Ramo:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_Ramo(extra, result, success)
if database:sismember(bot_id.."Ramo:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Ramo:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Ramo:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."Ramo:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."Ramo:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
local UserName = (b.username_ or "T_O_Y_S")
...
database:sadd(bot_id.."Ramo:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."Ramo:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"◈︙ تم مغادرة الكروب .") 
database:srem(bot_id.."Ramo:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."Ramo:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادرة" and DevRamo(msg) then   
database:del(bot_id.."Ramo:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"◈︙ تم تفعيل المغادرة .") 
return false 
end
if text == "تعطيل المغادرة" and DevRamo(msg) then  
database:set(bot_id.."Ramo:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "◈︙ تم تعطيل المغادرة .") 
return false 
end
if text == (database:get(bot_id.."Ramo:Name:Bot") or "الكس") then
Namebot = (database:get(bot_id.."Ramo:Name:Bot") or "الكس")
local namebot = {
"يا حبيب "..Namebot.. " كول",
"ها عمري اني "..Namebot,
'ها يروحا كول ؟',
...
if DevRamo(msg) then
database:setex(bot_id.."Ramo:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."Ramo:Status:Bc") and not DevRamo(msg) then 
send(msg.chat_id_, msg.id_,"◈︙ الاذاعة معطلة من المطور الاساسي .")
return false
end
database:setex(bot_id.."Ramo:Ramo:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Ramo:Ramo:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الي تريد تذيعه .\n◈︙ يمكنك الغاء الاذاعة بأرسال كلمة الغاء .") 
return false
end  
...
database:setex(bot_id.."Ramo:Ramo:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الي تريد تذيعه .\n◈︙ يمكنك الغاء الاذاعة بأرسال كلمة الغاء .") 
return false
end  
...
database:setex(bot_id.."Ramo:Ramo:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Ramo:Ramo:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◈︙ دز التوجيه عمري .") 
return false
end 

if text == "تفعيل الاذاعة" and DevRamo(msg) then  
database:del(bot_id.."Ramo:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n◈︙ تم تفعيل الاذاعة ." ) 
return false
end 
if text == "تعطيل الاذاعة" and DevRamo(msg) then  
database:set(bot_id.."Ramo:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n◈︙ تم تعطيل الاذاعة .") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."Ramo:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."Ramo:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."Ramo:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."Ramo:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقييد"     
elseif database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقييد"    
elseif database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقييد"    
elseif database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقييد"    
elseif database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقييد"    
elseif database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."Ramo:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."Ramo:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقييد"   
elseif database:get(bot_id.."Ramo:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."Ramo:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."Ramo:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقييد"    
elseif database:get(bot_id.."Ramo:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."Ramo:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."Ramo:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."Ramo:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."Ramo:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."Ramo:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."Ramo:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."Ramo:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."Ramo:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n◈︙ اعدادات الكروب ."..
"\n- - - - -"..
...
database:setex(bot_id.."Ramo:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
    ◈︙ ارسل النص الان .
    ◈︙ يمكنك اضافة ما يلي .
...
if Owner(msg) then
database:del(bot_id.."Ramo:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '◈︙ تم مصح كليشة الايدي .')
end
return false  
end 

if database:get(bot_id.."Ramo:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء تعيين الايدي .") 
database:del(bot_id.."Ramo:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."Ramo:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."Ramo:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'◈︙ تم تعيين الايدي .')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'Ramo:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'Ramo:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."Ramo:Spam:Group"..msg.sender_user_id_,text) 
...
local NumMsg = database:get(bot_id..'Ramo:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'Ramo:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."Ramo:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."Ramo:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'Ramo:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'Ramo:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."Ramo:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'Ramo:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."T_O_Y_S:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."Ramo:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'Ramo:Lock:ID:Bot'..msg.chat_id_) then
...
if database:get(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."T_O_Y_S:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","🍵","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","📡"}
SM = Random[math.random(#Random)]
database:set(bot_id.."T_O_Y_S:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"◈︙ اسرع واحد يدز هذا السمايل : {`"..SM.."`} .")
return false
end
end
if text == ""..(database:get(bot_id.."T_O_Y_S:Random:Sm"..msg.chat_id_) or "").."" and not database:get(bot_id.."T_O_Y_S:Set:Sma"..msg.chat_id_) then
if not database:get(bot_id.."T_O_Y_S:Set:Sma"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◈︙ انت فزت عمري . \n◈︙ للعب مرة اخرى ارسل سمايل او سمايلات .")
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."T_O_Y_S:Set:Sma"..msg.chat_id_,true)
return false
end 
if text == "الاسرع" or tect == "ترتيب" then
if database:get(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."T_O_Y_S:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
database:set(bot_id.."T_O_Y_S:Klam:Speed"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."T_O_Y_S:Klam:Speed"..msg.chat_id_) or "").."" and not database:get(bot_id.."T_O_Y_S:Speed:Tr"..msg.chat_id_) then
if not database:get(bot_id.."T_O_Y_S:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◈︙ انت فزت عمري .\n◈︙ للعب مرة اخرى ارسل ترتيب او الاسرع .")
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."T_O_Y_S:Speed:Tr"..msg.chat_id_,true)
end 

if text == "حزورة" then
if database:get(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."T_O_Y_S:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
database:set(bot_id.."T_O_Y_S:Klam:Hzor"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."T_O_Y_S:Klam:Hzor"..msg.chat_id_) or "").."" and not database:get(bot_id.."T_O_Y_S:Set:Hzora"..msg.chat_id_) then
if not database:get(bot_id.."T_O_Y_S:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◈︙ انت فزت عمري .\nللعب مرة اخرى ارسل حزورة .")
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."T_O_Y_S:Set:Hzora"..msg.chat_id_,true)
end 

if text == "معاني" then
if database:get(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."T_O_Y_S:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
database:set(bot_id.."T_O_Y_S:Maany"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."T_O_Y_S:Maany"..msg.chat_id_) or "").."" and not database:get(bot_id.."T_O_Y_S:Set:Maany"..msg.chat_id_) then
if not database:get(bot_id.."T_O_Y_S:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◈︙ انت فزت عمري .\n◈︙ للعب مرة اخرى ارسل معاني .")
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."T_O_Y_S:Set:Maany"..msg.chat_id_,true)
end 
if text == "العكس" then
if database:get(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."T_O_Y_S:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
database:set(bot_id.."T_O_Y_S:Set:Aks:Game"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."T_O_Y_S:Set:Aks:Game"..msg.chat_id_) or "").."" and not database:get(bot_id.."T_O_Y_S:Set:Aks"..msg.chat_id_) then
if not database:get(bot_id.."T_O_Y_S:Set:Aks"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"◈︙ انت فزت عمري .\n◈︙ للعب مرة اخرى ارسل العكس .")
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."T_O_Y_S:Set:Aks"..msg.chat_id_,true)
end 

if database:get(bot_id.."T_O_Y_S:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"◈︙ ارسل عدد بين ال1 وال20 .\n")
return false  end 
local GETNUM = database:get(bot_id.."T_O_Y_S:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."T_O_Y_S:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."T_O_Y_S:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"◈︙ انت فزت عمري .\n◈︙ للعب مرة اخرى ارسل تخمين او خمن .\n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:incrby(bot_id.."T_O_Y_S:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(database:get(bot_id.."T_O_Y_S:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
database:del(bot_id.."T_O_Y_S:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."T_O_Y_S:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
database:set(bot_id.."T_O_Y_S:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n◈︙ اهلا بك عزيزي في لعبة التخمين .\n- - - - -\n".."◈︙ يمكنك التخمين 3 مرات فقط .\n\n".."◈︙ خمن رقم ما بين ال1 وال20 .")
database:setex(bot_id.."T_O_Y_S:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end

if database:get(bot_id.."T_O_Y_S:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"◈︙ يوجد فقط 6 اختيارات .\n")
return false  end 
local GETNUM = database:get(bot_id.."T_O_Y_S:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."T_O_Y_S:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"◈︙ انت فزت وطلعت البات يحلو : { "..NUM.." } .\n◈︙ للعب مرة اخرى ارسل بات او محيبس .")
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."T_O_Y_S:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if database:get(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_) then   
Num = math.random(1,6)
database:set(bot_id.."T_O_Y_S:Games:Bat"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
database:setex(bot_id.."T_O_Y_S:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
database:del(bot_id.."T_O_Y_S:Set:Moktlf:Bot"..msg.chat_id_)
database:set(bot_id.."T_O_Y_S::Set:Moktlf"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."T_O_Y_S::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."T_O_Y_S:Set:Moktlf:Bot"..msg.chat_id_) then 
database:del(bot_id.."T_O_Y_S::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"◈︙ انت فزت عمري .\n◈︙ للعب مرة اخرى ارسل المختلف .")
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."T_O_Y_S:Set:Moktlf:Bot"..msg.chat_id_,true)
end
if text == "امثلة" then
if database:get(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_) then
mthal = {"جوز","ضراطه","الحبل","الحافي","شقره","بيدك","سلايه","النخله","الخيل","حداد","المبلل","يركص","قرد","العنب","العمه","الخبز","بالحصاد","شهر","شكه","يكحله",};
name = mthal[math.random(#mthal)]
database:set(bot_id.."T_O_Y_S:Set:Amth"..msg.chat_id_,name)
database:del(bot_id.."T_O_Y_S:Set:Amth:Bot"..msg.chat_id_)
...
if text == ""..(database:get(bot_id.."T_O_Y_S:Set:Amth"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."T_O_Y_S:Set:Amth:Bot"..msg.chat_id_) then 
database:del(bot_id.."T_O_Y_S:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"◈︙ انت فزت عمري .\n◈︙ للعب مرة اخرى ارسل امثلة .")
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."T_O_Y_S:Set:Amth:Bot"..msg.chat_id_,true)
end
if text == "تعطيل الالعاب" and Owner(msg) then   
database:del(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"\n◈︙ تم تعطيل الالعاب .") 
end
if text == "تفعيل الالعاب" and Owner(msg) then  
database:set(bot_id.."T_O_Y_S:Lock:Games"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"\n◈︙ تم تفعيل الالعاب .") 
end
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'Ramo:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '◈︙ عدد رسائلك : '..nummsg..' .'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'Ramo:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '◈︙ تم مسح كل رسائلك .'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'Ramo:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '◈︙ سحكاتك : '..edit..' .'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'Ramo:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '◈︙ تم مسح سحكاتك :'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."Ramo:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '◈︙ عدد جهاتك : '..addmem..' .'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'Ramo:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '◈︙ تم مسح كل جهاتك .'
send(msg.chat_id_, msg.id_,Text) 
end

if text == "مجوهراتي" then 
local Num = database:get(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
if tonumber(database:get(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"◈︙ ليس لديك مجوهرات .\n◈︙ ارسل الالعاب وابدأ بربح المجوهرات .") 
else
local NUM_GAMES = database:get(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\n◈︙ ليس لديك مجوهرات كافية .\n") 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id.."Ramo:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
if database:get(bot_id.."T_O_Y_S:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."T_O_Y_S:id:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "◈︙ تم الغاء الامر .") 
database:del(bot_id.."T_O_Y_S:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."T_O_Y_S:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."T_O_Y_S:id:user"..msg.chat_id_)  
database:del(bot_id.."T_O_Y_S:Msg_User"..msg.chat_id_..":"..msg.sender_user_id_) 
database:incrby(bot_id.."Ramo:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"◈︙ تم اضافة : {"..numadded.."} رسالة له .")  
end
if database:get(bot_id.."T_O_Y_S:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."T_O_Y_S:idgem:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "◈︙ تم الغاء الامر .") 
database:del(bot_id.."T_O_Y_S:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."T_O_Y_S:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."T_O_Y_S:idgem:user"..msg.chat_id_)  
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"◈︙ تم اضافة : {"..numadded.."} مجوهرة له .")  
end
------------------------------------------------------------
if text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then    
BROK = text:match("^اضف رسائل (%d+)$")
database:set(bot_id.."T_O_Y_S:id:user"..msg.chat_id_,BROK)  
database:setex(bot_id.."T_O_Y_S:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:set(bot_id.."T_O_Y_S:idgem:user"..msg.chat_id_,BROK)  
database:setex(bot_id.."T_O_Y_S:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:incrby(bot_id.."T_O_Y_S:Add:Num"..msg.chat_id_..result.sender_user_id_,Num)  
...
function reply(extra, result, success)
database:del(bot_id.."T_O_Y_S:Msg_User"..msg.chat_id_..":"..result.sender_user_id_) 
database:incrby(bot_id.."Ramo:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevRamo(msg) then
local pv = database:smembers(bot_id..'Ramo:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'Ramo:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevRamo(msg) then
local group = database:smembers(bot_id..'Ramo:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'Ramo:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and DevRamo(msg) then  
send(msg.chat_id_,msg.id_,'◈︙ تم تحديث السورس .')
os.execute('rm -rf Ramo.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/SourceRamo/SourceRamo/master/Ramo.lua', 'Ramo.lua') 
download_to_file('https://raw.githubusercontent.com/SourceRamo/SourceRamo/master/start.lua', 'start.lua') 
dofile('Ramo.lua')  
return false
end


if text == 'تفعيل البوت الخدمي' and DevRamo(msg) then  
database:del(bot_id..'Ramo:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'◈︙ تم تفعيل البوت الخدمي .') 
end
if text == 'تعطيل البوت الخدمي' and DevRamo(msg) then  
database:set(bot_id..'Ramo:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'◈︙ تم تعطيل البوت الخدمي .') 
end
if text and text:match("^تعيين عدد الاعضاء (%d+)$") and DevRamo(msg) then
local Num = text:match("تعيين عدد الاعضاء (%d+)$") 
database:set(bot_id..'Ramo:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'◈︙ تم تعيين عدد الاعضاء : '..Num..' .')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'Ramo:Chek:Groups')  
local Users = database:scard(bot_id..'Ramo:UsersBot')  
send(msg.chat_id_, msg.id_,'◈︙ احصائيات بوتك .\n\n◈︙ عدد الكروبات : '..Groups..' .\n◈︙ عدد المشتركين : '..Users..' .')
end
if text == 'جلب نسخة احتياطية' and DevRamo(msg) then
local list = database:smembers(bot_id..'Ramo:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'Ramo Chat'
ASAS = database:smembers(bot_id.."Ramo:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."Ramo:Constructor"..v)
MDER = database:smembers(bot_id.."Ramo:Manager"..v)
MOD = database:smembers(bot_id.."Ramo:Mod:User"..v)
link = database:get(bot_id.."Ramo:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"Ramo":"'..NAME..'",'
else
t = t..',"'..v..'":{"Ramo":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'Ramo:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and DevRamo(msg) then
t = '◈︙ الملفات .\n- - - - -\n'
i = 0
for v in io.popen('ls Ramo_Files'):lines() do
if v:match(".lua$") then
...
if DevRamo(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceRamo/SourceRamo/master/getfile.json")
if res == 200 then
...
local Check_File_is_Found = io.open("Ramo_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevRamo(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("Ramo_Files/"..file,"r")
if file_bot then
io.close(file_bot)
t = "◈︙ الملف : {"..file.."} .\n◈︙ تم تعطيله وحذفه ."
else
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceRamo/SourceRamo/master/"..file)
if res == 200 then
os.execute("rm -fr Ramo_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('T_O_Y_S.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevRamo(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceRamo/SourceRamo/master/"..file)
if res == 200 then
local chek = io.open("Ramo_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevRamo(msg) then
os.execute("rm -fr Ramo_Files/*")
send(msg.chat_id_,msg.id_,"◈︙ تم حذف جميع الملفات .")
return false
end
if text == 'نقل الاحصائيات' and DevRamo(msg) then
local Users = database:smembers('Ramo:'..bot_id.."userss")
local Groups = database:smembers('Ramo:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'Ramo:Chek:Groups',Groups[i])  
local list1 = database:smembers('Ramo:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."Ramo:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('Ramo:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."Ramo:Constructor"..Groups[i], v)
end
local list3 = database:smembers('Ramo:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."Ramo:Manager"..Groups[i], v)
end
local list4 = database:smembers('Ramo:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."Ramo:Mod:User"..Groups[i], v)
end
database:set(bot_id.."Ramo:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Ramo:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
database:sadd(bot_id..'Ramo:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'◈︙ تم نقل : '..#Groups..' كروب .\n◈︙ تم نقل : '..#Users..' مشترك .\n◈︙ من التحديث القديم الى التحديث الجديد .')
end
if text == 'حذف كليشة المطور' and DevRamo(msg) then
database:del(bot_id..'Ramo:Text_Dev')
send(msg.chat_id_, msg.id_,'◈︙ تم حذف كليشة المطور .')
end
if text == 'وضع كليشة المطور' and DevRamo(msg) then
database:set(bot_id..'Ramo:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'◈︙ ارسل الكليشة الان .')
return false
end
if text and database:get(bot_id..'Ramo:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'Ramo:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'◈︙ تم الغاء حفظ كليشة المطور .')
return false
end
database:set(bot_id..'Ramo:Text_Dev',text)
database:del(bot_id..'Ramo:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'◈︙ تم حفظ كليشة المطور .')
return false
end
if text == 'رفع نسخة احتياطية' and DevRamo(msg) then   
...
if text == "تحديث" and DevRamo(msg) then
dofile("Ramo.lua")  
...
{
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
},
{
{text = '- SainT .', url = "https://t.me/T_O_Y_S"}
},
{
{text = '- MY BOT .', url = "https://t.me/Moghoury_bot"}
},
}
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Ramo:Num:Add:Bot') or 0) and not DevRamo(msg) then
send(msg.chat_id_, msg.id_,'◈︙ لا يمكنك تفعيل البوت لان عدد الاهضاء اقل من : {'..(database:get(bot_id..'Ramo:Num:Add:Bot') or 0)..' .')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Ramo:Chek:Groups',msg.chat_id_) then
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
database:sadd(bot_id..'Ramo:Basic:Constructor23'..msg.chat_id_, owner_id)
end
end
end,nil)
database:sadd(bot_id..'Ramo:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'Ramo:Chek:Groups',msg.chat_id_) then
...
database:set(bot_id.."Ramo:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'Ramo:Free:Add:Bots') then 
local res = https.request('https://brok-aapi.ml/API/Sub.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'◈︙ اشترك بقناة السورس وارجع دز الامر عمري .\n◈︙ قناة السورس : @T_O_Y_S .')   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Ramo:Num:Add:Bot') or 0) and not DevRamo(msg) then
send(msg.chat_id_, msg.id_,'◈︙ لا يمكنك تفعيل البوت لان عدد الاعضاء اقل من : {'..(database:get(bot_id..'Ramo:Num:Add:Bot') or 0)..' .')
return false
end
...
database:sadd(bot_id..'Ramo:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'Ramo:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'Ramo:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevRamo(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if DevRamo(msg) and msg.reply_to_message_id_ ~= 0  then    
...
function tdcli_update_callback(data)
    ...
    if Text and Text:match('(.*)/help1') and Addictive(Ramo41j) then
...
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
    ...
    if Text and Text:match('(.*)/help2') and Addictive(Ramo41j) then
...
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
    ...
    if Text and Text:match('(.*)/help3') and Owner(Ramo41j) then
...
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
    ...
    if Text and Text:match('(.*)/help4') and Constructor(Ramo41j) then
...
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
    ...
    if Text and Text:match('(.*)/help5') and DevBot(Ramo41j) then
...
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
    ...
    if Text and Text:match('(.*)/help') and Addictive(Ramo41j) then
...
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
    ...
    database:del(bot_id.."Ramo:Link_Group"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."Ramo:Chek:Welcome"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."Ramo:Reply:Sudo"..Chat_id,true)   
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id..'Ramo:Lock:ID:Bot'..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id..'Ramo:Lock:ID:Bot:Photo'..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."Ramo:Kick:Me"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."Ramo:Reply:Manager"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."Ramo:Link_Group"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."Ramo:Chek:Welcome"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."Ramo:Reply:Sudo"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id..'Ramo:Lock:ID:Bot'..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id..'Ramo:Lock:ID:Bot:Photo'..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."Ramo:Kick:Me"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."Ramo:Reply:Manager"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
...
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
    ...
    database:set(bot_id.."Ramo:Lock:AddMempar"..Chat_id,"kick")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    ...
    elseif Text and Text:match('(.*)/lockchat') and Owner(Ramo41j) then
    if tonumber(Text:match('(.*)/lockchat')) == tonumber(data.sender_user_id_) then
    local Textedit = '• تم قفل الدردشة '
    database:set(bot_id.."Ramo:Lock:text"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Join"..Chat_id,"kick")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Bot:kick"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:tagservr"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    elseif Text and Text:match('(.*)/lockedit') and Owner(Ramo41j) then
    if tonumber(Text:match('(.*)/lockedit')) == tonumber(data.sender_user_id_) then
    local Textedit = '• تم قفل التعديل '
    database:set(bot_id.."Ramo:Lock:edit"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Link"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:User:Name"..Chat_id,"del") 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:hashtak"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Sticker"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Animation"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Video"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Photo"..Chat_id,"del")    
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Audio"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:vico"..Chat_id,"del")    
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:forward"..Chat_id,'del')  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Document"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Contact"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Spam"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:hset(bot_id.."Ramo:flooding:settings:"..Chat_id ,"flood","del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."Ramo:Lock:Inlen"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:AddMempar"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:text"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Join"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Bot:kick"..Chat_id)   
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:tagservr"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:edit"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Link"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:User:Name"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:hashtak"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Sticker"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Animation"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Video"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Photo"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Audio"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:vico"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:forward"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Document"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Contact"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Spam"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:hdel(bot_id.."Ramo:flooding:settings:"..Chat_id ,"flood")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."Ramo:Lock:Inlen"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
...
{text = '- Source Ramo .', url = "https://t.me/T_O_Y_S"}
    ...
    DeleteMessage(data.chat_id_,{[0] = Msg_id})    
    https.request('https://t.me/T_O_Y_S/='..Id_Link..'&token='..token..'&chat='..data.chat_id_..'&type=mp3&msg=0')
    elseif Text and Text:match('ogg/(.*)') then
    local Id_Link = Text:match('ogg/(.*)') 
    DeleteMessage(data.chat_id_,{[0] = Msg_id})    
    https.request('https://t.me/T_O_Y_S/'..Id_Link..'&token='..token..'&chat='..data.chat_id_..'&type=ogg&msg=0')
    elseif Text and Text:match('mp4/(.*)') then
    local Id_Link = Text:match('mp4/(.*)') 
    DeleteMessage(data.chat_id_,{[0] = Msg_id})    
    https.request('https://t.me/T_O_Y_S/'..Id_Link..'&token='..token..'&chat='..data.chat_id_..'&type=mp4&msg=0')
    end
    ...
    database:srem(bot_id..'Ramo:Chek:Groups','-100'..data.channel_.id_)  
    end
    end
    ...
    database:del(bot_id..'Ramo:nwe:mem:group'..msg.chat_id_) 
    send(msg.chat_id_, msg.id_,'\n- تم تعطيل التحقق' ) 
    end
    if text == 'تفعيل التحقق' and Addictive(msg) then  
    database:set(bot_id..'Ramo:nwe:mem:group'..msg.chat_id_,'true') 
    send(msg.chat_id_, msg.id_,'\n- تم تفعيل التحقق' ) 
    end 
    
    if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'Ramo:nwe:mem:group'..msg.chat_id_) == 'true'then
    numphoto = {'3','8','9','6'}
...
if text and not database:sismember(bot_id..'Ramo:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'Ramo:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'Ramo:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."Ramo:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."Ramo:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."Ramo:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."Ramo:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."Ramo:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."Ramo:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."Ramo:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."Ramo:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."Ramo:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."Ramo:Name:Bot") or "تشاكيx")
if not database:get(bot_id.."Ramo:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
Ramo_Started_Bot(msg,data)
Ramo_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'Ramo:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."Ramo:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
if database:get(bot_id.."Ramo:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."Ramo:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."Ramo:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."Ramo:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local Ramo_Msg = database:get(bot_id.."Ramo:Add:Filter:Rp2"..text..result.chat_id_)   
if Ramo_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..Ramo_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'Ramo:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'Ramo:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'Ramo:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'Ramo:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'Ramo:Chek:Groups',v)  
end
...
database:sadd(bot_id..'Ramo:Chek:Groups',v)  
end end,nil)
end;end;end
